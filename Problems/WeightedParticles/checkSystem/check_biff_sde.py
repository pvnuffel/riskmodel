        ...
        for n in range(nN):  
         ...
         #  Jv =fp_sde.applyJacobian(v)                                                 
           ...
           # linsolv2 = GMRES.GMRESLinearSolver(gmres_param)
            ...
            newt_param['rel_tol']=1e-8
        #    newt_param['abs_tol']=3e-3
#            if (N== 1e6):
#                 newt_param['abs_tol']=1e-3
            newt_param['abs_tol']=0.5/np.sqrt(N)
    ...
    #        p2 = Point.Point(fp_sde2,nsolv2,psolver_im2,point_param)
     #       p2.correct()
            ...
            continuer_param['plotx']['func'] = 2   #continuation in alpha
            continuer_param['ploty']['func'] =  'mean'
            continuer_param['growth_factor']=1
            continuer_param['cont_step']=-0.1
            continuer_param['add_failures']= True
       ...
       #     N_iter = branch.getIterations()
            ...
            np.savetxt('Biff_Ne6_80steps_RL.txt', y_sde)
       ...
       #     np.savetxt('Newton/residual_8it_N1e6',  residual)
          ...
          #np.savetxt('Newton/Newton_states_8it_N1e7_Dt_10', States)
